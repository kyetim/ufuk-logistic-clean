                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <Card className="bg-white/80 backdrop-blur-sm border-white/20 shadow-xl text-center">
                            ...
                            <CardContent>
                                ...
                                <p className="text-gray-600 leading-relaxed" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(t('kvk.contact.address.content') as string) }}>
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-white/80 backdrop-blur-sm border-white/20 shadow-xl text-center">
                            ...
                            <CardContent>
                                {/* Security: Sanitize translation string to prevent XSS */}
                                <p className="text-gray-600 leading-relaxed" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(t('kvk.contact.email.content') as string) }}>
                                </p>
                            </CardContent>
                        </Card>
