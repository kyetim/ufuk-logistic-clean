            ...
            <div className="relative">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">{t("kvk.secure.subtitle")}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {kvkSections.map((section, index) => (
              <Card
                key={index}
                className="bg-white/80 backdrop-blur-sm border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
              >
                <CardHeader>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-white/80 backdrop-blur-sm border-white/20 shadow-xl text-center">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-gray-900">
                  {t("kvk.contact.address.title")}
                </CardTitle>
              </CardHeader>
              <CardContent>
                {/* Security: Sanitize translation string to prevent XSS */}
                <p
                  className="text-gray-600 leading-relaxed"
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize(
                      t("kvk.contact.address.content"),
                    ),
                  }}
                ></p>
              </CardContent>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-white/20 shadow-xl text-center">
              ...
              <CardContent>
                ...
                <p
                  className="text-gray-600 leading-relaxed"
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize(t("kvk.contact.email.content")),
                  }}
                ></p>
              </CardContent>
            </Card>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    <strong>{t("kvk.notes.conditions.title")}</strong>{" "}
                    {t("kvk.notes.conditions.content")}
                  </p>
                  <p>
                    <strong>{t("kvk.notes.pricing.title")}</strong>{" "}
                    {t("kvk.notes.pricing.content")}
                  </p>
                  <p>
                    <strong>{t("kvk.notes.changes.title")}</strong>{" "}
                    {t("kvk.notes.changes.content")}
                  </p>
                </div>
              </div>
            </div>
