                        ...
                        <div className="lg:col-span-3">
                            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-2xl overflow-hidden">
                                ...
                                <CardContent className="p-8">
                                    {/* Article Content */}
                                    {/* Security: Sanitize dynamic content to prevent XSS, allowing iframes for embedded videos */}
                                    <div
                                        className="prose prose-lg max-w-none text-gray-700 leading-relaxed"
                                        dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(event.content, { ADD_TAGS: ['iframe'], ADD_ATTR: ['allow', 'allowfullscreen', 'frameborder', 'scrolling'] }) }}
                                    />
