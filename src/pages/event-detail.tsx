      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">
            {t("eventDetail.notFound.message")}
          </p>
          <Link
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="text-gray-300">
              <span className="font-medium">{t("eventDetail.eventType")}</span>{" "}
              {event.type}
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-3">
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-2xl overflow-hidden">
                ...
                <CardContent className="p-8">
                  {/* Article Content */}
                  {/* Security: Sanitize dynamic content to prevent XSS */}
                  <div
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        <svg
                          className="w-5 h-5 mr-3 text-purple-500 mt-1"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div className="flex items-start">
                        <svg
                          className="w-5 h-5 mr-3 text-blue-500 mt-1"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div className="flex items-start">
                        <svg
                          className="w-5 h-5 mr-3 text-green-500 mt-1"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div className="flex items-start">
                        <svg
                          className="w-5 h-5 mr-3 text-orange-500 mt-1"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                ...
                <Card className="bg-gradient-to-br from-purple-500 to-blue-600 border-0 shadow-xl rounded-2xl">
                  <CardContent className="p-6 text-white">
                    <h3 className="text-xl font-bold mb-4">
                      {t("eventDetail.eventCooperation")}
                    </h3>
